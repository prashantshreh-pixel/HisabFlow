        ...
        <div>
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-950/50 sticky top-0 z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-100">Add New Khata Customer</h3>
                <p className="text-xs text-slate-400">Slide-over drawer • Register customer to track credit ledger & sales</p>
              </div>
            </div>
            <button
          ...
          {/* Form Body */}
          <form id="add-customer-drawer-form" onSubmit={handleSubmit} className="p-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-700 rounded-xl text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all"
              />
